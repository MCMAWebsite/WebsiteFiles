...
file_list_path = file.path(user_website, "pureRDSfiles", "file_list_pure")
...
for (i in 1:length(file_list_new_pure)) {
  file = file.path(user_website, "conj_data", file_list_new_pure[i])
...
saveRDS(file_list_pure, file_list_path)
...
#saveRDS(all_conjs_pure,"~/all_conjs_pure")
